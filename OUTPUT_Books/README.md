# Book of nodeJS API (backend) to a fast develop
...
Note that you will have to modify the tests in `book.test.js` to adapt them to the new modifications made.
